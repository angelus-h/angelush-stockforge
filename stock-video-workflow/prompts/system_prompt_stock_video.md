...
- **Naming Rules:**
  ...
  - **MANDATORY DEFAULT FOR TIMELAPSES:** Whenever a video is a time-lapse, hyperlapse, or fast motion, the word `timelapse` MUST strictly be included in the filename (e.g. `<location>_<theme>_timelapse_<shot>.mp4`). Never omit `timelapse` from the file name.
- **Examples:**
  - `lednice_castle_gardens_timelapse_wide.mp4`
  - `lednice_minaret_lake_sunset_timelapse.mp4`
...
- **Title:** Strictly **40 to 80 characters**.
  - If Editorial: strictly formatted according to official Pond5 guide: `City, Country YYYY/MM/DD: <Subject Action>` (strictly NO ALL-CAPS).
  - If Commercial: Formula: `[Main subject] + [Action] + [Environment] + [Type of shot]`.
- **Description:** 
  - If Editorial: strictly formatted according to official Pond5 guide: `City, Country YYYY/MM/DD: <Factual description of the content>` (strictly NO ALL-CAPS).
  - If Commercial: Engaging factual description without dateline.
- **Editorial:** `yes` or `no`.
...
- **Video Name:** Short descriptive title in English. If Editorial, strictly formatted with dateline: `City, Country - Month Day, Year: <Subject Action>` (strictly NO ALL-CAPS).
