...
- **Pond5:** Strict Title length (40-80 chars). If Editorial: strictly formatted with dateline: `City, Country YYYY/MM/DD: <Subject Action>` (e.g. `Rome, Italy 2026/06/18: Morning Traffic on City Street`). If Commercial: `[Subject] [Action] [Environment] [Shot type]`. Editorial Description: `City, Country YYYY/MM/DD: Factual description`. Strictly NO ALL-CAPS, no quotes or prohibited special characters.
- **Dreamstime:** Video Name (`City, Country - Month Day, Year: <Subject Action>`) + Editorial 5 Ws Description (`City, Country - Month Day, Year: [Who] [What] [Where] [Why]`) + 3 separate Numeric Categories + Editorial Flags. (No ALL-CAPS; never uses category ID 2). 
...
- **Default for Time-lapses:** If a video depicts accelerated motion or is a time-lapse/hyperlapse, the tag `timelapse` is **mandatorily included** in the filename (e.g. `lednice_castle_gardens_timelapse_wide.mp4`).
